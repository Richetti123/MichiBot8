...
say(`Por Richetti y GeriPium\nsi eres mi noviecita geri te amo`, {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']})
...
┊${chalk.blueBright('┊')}${chalk.cyan(`😺 Project Author: ${packageJsonObj.author.name} (@ceogeripium.dzn)`)}
┊${chalk.blueBright('┊')}${chalk.blueBright('┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')} 
┊${chalk.blueBright('┊')}${chalk.yellow(`💜 Colaboradores:`)}
┊${chalk.blueBright('┊')}${chalk.yellow(`• Richetti (@richetti_123)`)}
┊${chalk.blueBright('┊')}${chalk.yellow(`• Geripium (@ceogeripium.dzn)`)}
┊${chalk.blueBright('╰┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')} 
┊${chalk.blueBright('╭┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')}
